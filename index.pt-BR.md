...
### Fixed
+- Corrigido o autocomplete que exibia sugestoes irrelevantes (busca "fuzzy") ao digitar parametros de funcoes. A logica foi alterada para uma busca estrita de "comeca com", resultando em sugestoes mais limpas e precisas.
...
+  - Variaveis globais.
+  - **Funcoes em Tasks:** Navegue direto para a funcao quando o nome dela e passado como texto (ex: `set_task_ex(..., "minha_funcao", ...)`).
...
Este projeto e uma modernizacao de uma base de codigo legada, agora utilizando TypeScript e as APIs mais recentes do `vscode-languageclient`. Contribuicoes sao bem-vindas.
